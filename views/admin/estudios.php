...
<div class="d-flex justify-content-between mb-4">
    <h2 class="text-warning">Gestión de Estudios</h2>
...
<div class="container">
    <?php if ($_GET['msg'] === 'actualizado'): ?>
            <div class="alert alert-success alert-dismissible fade show">
                ✔️ Estudio actualizado correctamente.
                <button class="btn-close" data-bs-dismiss="alert"></button>
            </div>
        <?php elseif ($_GET['msg'] === 'eliminado'): ?>
            <div class="alert alert-success alert-dismissible fade show">
                🗑️ Estudio eliminado correctamente.
                <button class="btn-close" data-bs-dismiss="alert"></button>
            </div>
    ...
    <?php endif; ?>
        <table id="tablaEstudios" id="tablaEstudios" class="table table-striped table-dark table-hover w-100">
            <thead>
                <tr>
            ...
            <?php foreach ($estudios as $row): ?>
                <tr>
                    <td class="col-id"><?= $row['ID_ESTUDIO'] ?></td>
                    <td><?= htmlspecialchars($row['NOMBRE']) ?></td>
                    <td>
                        <button class="btn btn-warning btn-sm btnEditar"
                            data-id="<?= $row['ID_ESTUDIO'] ?>"
...
<div class="modal fade" id="modalAgregar">
    <div class="modal-dialog">
        <form id="formAgregar" method="POST" action="/Videoteca_ElResplandor/estudios/crear" class="modal-content bg-dark text-light">
            <input type="hidden" name="action" value="insert">
            <div class="modal-header">
                <h5 class="modal-title text-warning">Agregar Estudio</h5>
...
<div class="modal fade" id="modalEditar">
    <div class="modal-dialog">
        <form id="formEditar" method="POST" action="/Videoteca_ElResplandor/estudios/actualizar" class="modal-content bg-dark text-light">
            <input type="hidden" name="action" value="update">
            <input type="hidden" id="editId" name="id">
            <div class="modal-header">
                <h5 class="modal-title text-warning">Editar Estudio</h5>
                <button class="btn-close bg-light" data-bs-dismiss="modal" type="button"></button>
            </div>
            <div class="modal-body">
...
<div class="modal fade" id="modalEliminar">
    <div class="modal-dialog">
        <form method="POST" action="/Videoteca_ElResplandor/estudios/eliminar" class="modal-content bg-dark text-light">
            <input type="hidden" name="action" value="delete">    
            <input type="hidden" id="deleteId" name="id">
            <div class="modal-header">
                <h5 class="modal-title text-danger">Eliminar Estudio</h5>
                <button class="btn-close bg-light" data-bs-dismiss="modal" type="button"></button>
            </div>
            <div class="modal-body">
                ¿Realmente deseas eliminar el Estudio:
