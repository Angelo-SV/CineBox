...
<div class="modal fade" id="modalAgregar">
    <div class="modal-dialog">
        <form id="formAgregar" method="POST" action="<?= BASE_PATH ?>/actores/crear" class="modal-content bg-dark text-light">
...
<div class="modal fade" id="modalEditar">
    <div class="modal-dialog">
        <form id="formEditar" method="POST" action="<?= BASE_PATH ?>/actores/actualizar" class="modal-content bg-dark text-light">
...
<div class="modal fade" id="modalEliminar">
    <div class="modal-dialog">
        <form method="POST" action="<?= BASE_PATH ?>/actores/eliminar" class="modal-content bg-dark text-light">
